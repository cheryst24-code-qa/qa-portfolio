...
### [3.1. 📡 API-тестирование (HiTE PRO Gateway) через Postman + Newman](https://github.com/cheryst24-code-qa/hitepro-api-tests/blob/main/docs/MANUAL-TESTING.md)
...
### [4. 🗄️ Валидация API <-> БД (ЛЭРС УЧЁТ)](https://github.com/cheryst24-code-qa/lers-api-db-check)
