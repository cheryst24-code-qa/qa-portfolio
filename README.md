...
Помимо тестирования коммерческих продуктов, я развиваю собственную платформу для QA-инженеров и DevSecOps - **[neiroqa.ru](https://neiroqa.ru)**.  
Это self-hosted экосистема для нагрузочного и security-тестирования, а также управления знаниями команды под единым SSO.
