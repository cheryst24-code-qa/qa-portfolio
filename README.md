...
Помимо тестирования коммерческих продуктов, я развиваю собственную платформу для QA-инженеров - **NeiroQA**, объединяющую в настоящее время инструменты нагрузочного, security-тестирования и управления знаниями команды под единым SSO.
...
- Security-тестирование (OWASP ZAP)
