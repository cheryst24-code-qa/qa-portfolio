...
## Тестирование API и автоматизация:
   ...
   [🔗 Тестирование API Reqres.in](./Practice_on_the_course/api_testing_postman)
...
---
   ...
   [🔗 Тестирование через данные: работа с БД LERS (MSSQL)](./Practice_on_the_course/sql_queries/README.md) 
