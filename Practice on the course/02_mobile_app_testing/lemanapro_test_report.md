...
## Примечание по воспроизведению дефектов безопасности
...
**Рекомендация:** Все тесты безопасности, особенно связанные с инъекциями и обработкой ввода, **обязательно должны проводиться на физических устройствах**, так как эмуляторы могут не отражать реальное поведение приложения в продакшн-среде.

*Дополнение от 28 ноября 2025*
